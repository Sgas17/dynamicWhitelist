...
from .base import CacheInterface, ConnectionError, DataError, StorageBase
...
class RedisStorage(StorageBase, CacheInterface):
    ...
    async def set_whitelist(
        self, chain: str, whitelist: List[Dict[str, Any]], ttl: int = 3600
    ) -> bool:
        """
    ...
    async def set_pool_data(
        self, chain: str, protocol: str, pools: List[Dict[str, Any]], ttl: int = 1800
    ) -> bool:
        """

...
async def test_whitelist_manager():
    ...
    try:
        ...
        async with WhitelistManager(db_config) as manager:
            ...
            assert result2['update_type'] == 'differential', "Second update should be 'differential'"
            ...
            with psycopg2.connect(**db_config) as conn:
                with conn.cursor() as cur:
                    ...
                    for snapshot_id, pool_count, published_at in snapshots:
                        print(f"      Snapshot {snapshot_id}: {pool_count} pools at {published_at}")

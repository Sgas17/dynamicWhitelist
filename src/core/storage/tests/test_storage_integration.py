...
class TestStorageIntegration:
    ...
    async def test_postgres_operations_if_available(self):
        ...
        async with StorageManager() as storage:
            ...
            test_symbols = {t['symbol'] for t in all_tokens if t['symbol'] in ['TEST1', 'TEST2']}
            ...
            # Store pools
            count = await storage.postgres.store_pools_batch(test_pools, 'ethereum', 'uniswap_v3')
            assert count == 1
            
            # Retrieve pool
            pool = await storage.postgres.get_pool('0xtest1234567890abcdef1234567890abcdef1234', 'ethereum')
    ...
    async def test_high_level_operations(self):
        ...
        async with StorageManager() as storage:
            ...
            results = await storage.save_whitelist_everywhere('test_chain', test_whitelist)
...
if __name__ == "__main__":
    ...
    async def run_tests():
        ...
        tests = [
            ...
            ("PostgreSQL Operations", test_instance.test_postgres_operations_if_available),

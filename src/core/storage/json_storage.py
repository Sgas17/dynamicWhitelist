...
from .base import DataError, StorageBase
...
class JsonStorage(StorageBase):
    ...
    def load_backup(self, filename: str, backup_index: int = 0) -> Optional[Any]:
        ...
        try:
            ...
            backup_path = filepath.with_suffix(
                f".backup{backup_index}{filepath.suffix}"
            )
    ...
    def save_pools(
        self, chain: str, protocol: str, pools: List[Dict[str, Any]]
    ) -> bool:
        """
    ...
    def save_all_whitelists(
        self, whitelists: Dict[str, List[Dict[str, Any]]]
    ) -> Dict[str, bool]:
        """

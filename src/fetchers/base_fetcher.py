...
class BaseFetcher(CryoFetcher):
    ...
    async def fetch_uniswap_v3_pools(
        ...
        try:
            ...
            self.logger.info(
                f"Fetching Base Uniswap V3 pools from block {start_block} to {latest_block}"
            )
    ...
    async def fetch_aerodrome_v3_pools(
        ...
        try:
            ...
            self.logger.info(
                f"Fetching Aerodrome V3 pools from block {start_block} to {latest_block}"
            )
    ...
    async def fetch_uniswap_v4_pools(
        ...
        try:
            ...
            self.logger.info(
                f"Fetching Base Uniswap V4 pools from block {start_block} to {latest_block}"
            )
    ...
    async def fetch_uniswap_v4_liquidity_events(
        ...
        try:
            ...
            self.logger.info(
                f"Fetching Base Uniswap V4 liquidity events from block {start_block} to {end_block}"
            )

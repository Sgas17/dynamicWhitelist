...
from ....fetchers import CryoFetcher, get_fetcher, list_fetchers
...
async def test_ethereum_fetcher():
    ...
    try:
        ...
        start, end = await fetcher.calculate_block_range(1)  # 1 hour back
...
async def test_fetch_simulation():
    ...
    try:
        ...
        scenarios = [
            ...
            (
                "Liquidity events",
                lambda: fetcher.fetch_liquidity_events("uniswap_v3", 1),
            ),
        ]

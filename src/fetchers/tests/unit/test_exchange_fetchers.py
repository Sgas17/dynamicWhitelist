...
class TestBaseExchangeFetcher:
    ...
    def test_should_include_market_default(self):
        ...
        with patch("ccxt.binance") as mock_exchange:
            ...
            assert (
                fetcher._should_include_market({"active": True, "base": "BTC"}) is True
            )

            # Inactive market
            assert (
                fetcher._should_include_market({"active": False, "base": "BTC"})
                is False
            )

            # No base asset
            assert fetcher._should_include_market({"active": True, "base": ""}) is False
...
class TestHyperliquidFetcher:
    ...
    def test_should_include_market_hyperliquid_logic(self):
        ...
        with patch("ccxt.hyperliquid") as mock_exchange:
            ...
            # Valid USD quote
            assert (
                fetcher._should_include_market(
                    {"active": True, "base": "BTC", "quote": "USD"}
                )
                is True
            )
            ...
            assert (
                fetcher._should_include_market(
                    {"active": False, "base": "BTC", "quote": "USD"}
                )
                is False
            )
...
class TestBinanceFetcher:
    ...
    def test_should_include_market_binance_logic(self):
        ...
        with patch("ccxt.binance") as mock_exchange:
            ...
            assert (
                fetcher._should_include_market(
                    {"active": True, "base": "BTC", "quote": "RANDOM"}
                )
                is False
            )

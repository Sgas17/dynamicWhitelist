...
w3 = Web3(Web3.HTTPProvider("https://base-mainnet.g.alchemy.com/v2/9tUX8QBj5DftD8imSlMpHUdRvmBY4yy-"))

with open(os.path.join(f"itrc_chain_data/itrc_contracts/{os.getenv('CHAIN_ID')}", 'UniswapAeroV2ReservesGetter.json'), "r" ) as f:
...
block_number, decoded_return_data = decode(["uint256", "bytes32[2][]"], encoded_return_data) 

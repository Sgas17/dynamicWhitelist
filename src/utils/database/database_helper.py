...
UNISWAP_V3_FACTORY_ADDRESSES = [
    "0x1F98431c8aD98523631AE4a59f267346ea31F984".lower(),
    "0xC0AEe478e3658e2610c5F7A4A2E1777cE9e4f2Ac".lower(),
    "0x0BFbCF9fa4f9C56B0F40a671Ad40E0805A091865".lower(),
]
...
def store_pools_to_database(pool_data: List[Dict]):
    ...
    if duplicates_removed > 0:
        logger.warning(
            f"Removed {duplicates_removed} duplicate pool addresses from database insert"
        )
